...
11. 从浏览器地址栏输入网址，到网页彻底打开，中间都发生了什么？
   - DNS域名解析
     - 客户端输入域名后，由DNS服务器来将域名解析成对应服务器的IP地

   - 建立TCP连接；
     - 获得服务器IP之后，就需要三次握手的协议才能建立连接
  　　　- 客户端发送SYN包请求，等待服务器确认
  　　　- 服务器确认收到SYN包请求后，同时自己也返回一个包给客户端，即返回SYN+ACK
  　　　- 客户端收到SYN+ACK包之后，返回给服务器一个确认包ACK包表示收到，然后双方达成协议，建立连接
...
　　　- 　500 Internal Server Error 一般来说，这个问题都会在服务器端的源代码出现错误时出现。。　　
   ...
   - 断开连接：
     ...
     - 客户端发送给服务器，告诉服务器需要关闭tcp了
     - 服务器发送给客户端，告诉客户端我准备一下就关闭
     - 服务器发送给客户端，告诉客户端我已经准备好关闭了
     - 客户端发送给服务器，告诉服务器我也准备好关闭了。
